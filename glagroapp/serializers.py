...
class FertilizerOrderSerializer(serializers.ModelSerializer):
    fertilizer_name = serializers.CharField(source="fertilizer.name_sw", read_only=True)
...
class SeedSerializer(serializers.ModelSerializer):
    class Meta:
        model = Seed
        fields = '__all__'   # itajumuisha fields zote (name_sw, name_en, description, image, price, timestamps)
